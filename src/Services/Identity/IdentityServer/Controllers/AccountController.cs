...
using mCore.Services.IdentityServer.Models.AccountViewModels;
using mCore.Services.IdentityServer.Services;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var user = userManager.Users.Single(m => m.UserName == model.Username);
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { Name = model.Email, UserName = model.Email, Email = model.Email };
